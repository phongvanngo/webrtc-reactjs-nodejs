...
const appId: string = "cea6cf40f19f4381a06a497e846a6adb"; //ENTER APP ID HERE
const token: string | null = "007eJxTYAid827vmXcmb/TD9NTOTzfzfviE8cLT/4tlfC/xFQcqLnZTYEhOTTRLTjMxSDO0TDMxtjBMNDBLNLE0T7UwMUs0S0xJsuJ/lNwQyMiwRJOTiZEBAkF8Joa8fAYGAFtyHrs="

const App = () => {
  const [inCall, setInCall] = useState(false);
  const [channelName, setChannelName] = useState("novapo");
  return (
    <div>
